...
using FaceRecognitionDemo.Properties;
...
namespace FaceRecognitionDemo
{
    public class UtilTool
    {
        ...
        /// <param name="bitmap"></param>
        /// <returns></returns>
        public static BitmapImage BitmapToBitmapImage(System.Drawing.Image image)
        {
            using (MemoryStream memory = new MemoryStream())
            {
        ...
        /// <summary>
        /// 将BitmapImage存入指定路径文件夹
        /// </summary>
        /// <param name="bitmapImage"></param>
        /// <param name="filePath"></param>
        public static void Save_BitmapImage_Into_File(BitmapImage bitmapImage ,string fileName, string filePath)
        {
            BitmapEncoder encoder = new PngBitmapEncoder();
            encoder.Frames.Add(BitmapFrame.Create(bitmapImage));
            using (var fileStream = new System.IO.FileStream(Path.Combine(filePath, fileName), FileMode.Create)) 
            {
        ...
        /// <summary>
        /// 创建当前用户FullControl文件夹
        /// </summary>
        /// <param name="path"></param>
        public static void CreateDirectory_FullControl(string path)
        {
        ...
        /// 从文件中读取图片
        /// </summary>
        /// <param name="imageUrl">图片所在路径</param>
        /// <returns></returns>
        public static Image ReadImageFromFile(string imageUrl)
        {
            Image img = null;
            FileStream fs = null;
            try
